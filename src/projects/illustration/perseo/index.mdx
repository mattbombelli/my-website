...
<Slide class="col-one-six text-center"><Image src={Perseo} alt="Illustration of Perseo withholding the eye from the three Graeae" loading="eager" quality="max"/></Slide>
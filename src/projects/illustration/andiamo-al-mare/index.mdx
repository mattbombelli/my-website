...
<Slide class="col-one-six text-center"><Image src={Mare} alt="A man walking on the beach with the shadow of his father. A woman walks with him." loading="eager" quality="max"/></Slide>

<Slide class="col-one-six text-center"><Image src={Book} alt='Open magazine "Carie Letterarie" laying on grass.' loading="lazy" quality="max"/></Slide>